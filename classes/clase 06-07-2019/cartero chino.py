...
if __name__ == "__main__":
	...
	# ]
	graphNodes=[
		["A", {"color":"silver", "pos":np.array([0, 1])}], 
		["B", {'color':"silver", "pos":np.array([1, 2])}],
		["C", {'color':"silver", "pos":np.array([1, 0])}],
		["D", {"color":"silver", "pos":np.array([2, 1])}], 
		["E", {"color":"silver", "pos":np.array([3, 2])}], 
		["F", {"color":"silver", "pos":np.array([3, 0])}],
		["G", {"color":"silver", "pos":np.array([4, 1])}],
		["H", {"color":"silver", "pos":np.array([5, 2])}],
		["I", {"color":"silver", "pos":np.array([5, 1])}],
		["J", {"color":"silver", "pos":np.array([5, 0])}]
	]
	...
	graphEdges=[
		["A", "B", {"color":"silver", "weight":8}], 
		["A", "C", {"color":"silver", "weight":5}],
		["A", "D", {"color":"red", "weight":6}],
		["B", "D", {"color":"silver", "weight":7}],
		["C", "D", {"color":"silver", "weight":9}],
		["D", "E", {"color":"silver", "weight":12}],
		["D", "F", {"color":"red", "weight":6}],
		["D", "G", {"color":"silver", "weight":13}],
		["E", "G", {"color":"silver", "weight":8}],
		["E", "H", {"color":"red", "weight":9}],
		["F", "G", {"color":"red", "weight":4}],
		["H", "I", {"color":"silver", "weight":13}],
		["G", "I", {"color":"red", "weight":3}],
		["G", "J", {"color":"silver", "weight":3}],
		["G", "H", {"color":"silver", "weight":14}],
		["I", "J", {"color":"silver", "weight":1}]
